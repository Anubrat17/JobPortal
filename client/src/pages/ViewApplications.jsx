...
const ViewApplications = () => {
  return (
    <div className='container mx-auto p-4'>
      <div>
          <table className='w-full max-2-4xl bg-white border border-gray-200 max-sm:text-sm'>
            <thead>
                ...
                <tr key = {index} className='text-gray-700'>
                  ...
                  <td className='py-2 px-4 border-b'>
                    ...
                    className='bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex gap-2 items-center'>
                       Resume <img src = {assets.resume_download_icon} alt="Download Resume" />
                    </a>
                  </td>
                  <td className='py-2 px-4 border-b relative '>
                    <div className='relative inline-block text-left group'>
                      <button className='text-gray-500 action-button'>...</button>
                      <div className='z-10 hidden absolute right-0 md:left-top-0 mt-2 w-32 bg-white border border-gray-200 rounde shadow group-hover:block'>
